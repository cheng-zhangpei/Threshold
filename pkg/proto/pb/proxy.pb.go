...
type ConnectionInit struct {
	...
	TargetAddr    string `protobuf:"bytes,7,opt,name=target_addr,json=targetAddr,proto3" json:"target_addr,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConnectionInit) GetTargetAddr() string {
	if x != nil {
		return x.TargetAddr
	}
	return ""
